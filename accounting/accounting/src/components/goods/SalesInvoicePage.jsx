...
export default function SalesInvoicePage() {
 ...
 const handleSubmitInvoice = async () => {
  ...
  try {
    ...
    // ثبت فاکتور اصلی در tblSalesInvoice
    const firstLine = lines[0];

const invoiceRes = await fetch("http://localhost:5000/api/salesinvoices", {
  method: "POST",
  ...
  body: JSON.stringify({
    ...
    // ثبت سایر کالاها در tblSale و tblStockTransaction
    ...
    alert("❌ خطا در ثبت فاکتور: " + err.message);
  }
};
